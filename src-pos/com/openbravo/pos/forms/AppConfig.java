...
public class AppConfig implements AppProperties {
    ...
    private void loadDefault() {
        ...
        m_propsconfig.setProperty("db.driverlib", new File(new File(dirname), "lib/postgresql-9.4.1209.jar").getAbsolutePath());
        m_propsconfig.setProperty("db.driver", "org.postgresql.Driver");
        m_propsconfig.setProperty("db.URL", "jdbc:postgresql://localhost:5432/prideusPDV");
